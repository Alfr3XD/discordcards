...
class Level {
     ...
     * colors?: { bar?: string | {hex: string, position: number}[], stroke?: string, username: string, nickname: string, level: string, rank: string, xp: string },
    ...
    */
    ...
    async render() {
        ...
        ctx.shadowOffsetY = 8;
        ctx.shadowOffsetX = -6;
        fillRoundRect(ctx, 35, 25, 200, 200, 35, false, true);
        ctx.clip();
